...
// Standard Input/Output functions.
	...
	#define START_TIMER2 TCCR2=(1<<CS02)|(0<<CS01)|(1<<CS00);	//Timer2 start clock.
	#define STOP_TIMER2 TCCR2=(0<<CS02)|(0<<CS01)|(0<<CS00);	//Timer2 stop clock.
...
//	GetTimeSIM();
	...
	for(uint8_t t0; t0<sizeof(data_time); t0++) usart0_write(data_time[t0]);
...
ISR(TIMER2_OVF_vect){
	...
	if(count_relay==200)
	{
		if(PINC & RELAY1) PORT_OUT&=~RELAY1; else PORT_OUT|=RELAY1;
		count_relay=0;
	}
		else
		{
